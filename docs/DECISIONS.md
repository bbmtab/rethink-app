...
`WgHopManager.kt` + `WgHopManagerTest.kt` = UPSTREAM. All 9 source + 3 test commits authored by `hussainmohd-a <hussainmohd.a@gmail.com>`; reference SHAs `b935b1c66` ("wg: hop changes wrt to rpn", 2026-04-26) and `3b81c5505` ("optimize imports", 2026-06-14). Zero Antigravity AI touch. Pre-dates all local Phase work.
