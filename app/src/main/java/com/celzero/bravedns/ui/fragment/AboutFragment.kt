...
class AboutFragment : Fragment(R.layout.fragment_about), View.OnClickListener, KoinComponent {
    ...
    private fun updateSponsorInfo() {
        // Bridge (Plus, O8): RPN user-facing destination retired — the
        // manage-RPN card stays hidden; always present the RethinkDNS
        // sponsor path. Upstream's sponsored-state machinery kept below.
