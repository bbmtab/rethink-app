...
object ViewModelModule {
    private val modelModules = module {
        ...
        // Bridge: RPN purchase VMs (PurchaseHistory/ManagePurchase/
        // ServerOrderHistory/ServerSelection) retired with the RPN UI —
        // their classes were removed. Surviving upstream VMs kept.
