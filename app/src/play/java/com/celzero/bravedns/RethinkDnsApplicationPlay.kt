            ...
            koin.loadModules(
                listOf(
                    module {
                        ...
                        // InAppMessageProvider override removed (PlayInAppMessageProvider retired
                        // with the RPN UI pivot). NoOpInAppMessageProvider from the base
                        // updaterModule is used instead.
                    }
                )
            )
        }
