...
import com.celzero.bravedns.core.proxy.policy.InspectionPackagePresetParser
    ...
    private fun initHttpsInspectionListAdapter() {
        ...
        val systemHardBypass =
            InspectionPackagePresetParser()
                .parsePackagesAndUids(
                    assets.open(
                        InspectionPolicyPresetLoader
                            .SYSTEM_HARD_BYPASS_ASSET_PATH
                    )
                )
        ...
        val controller =
            InspectionAppPolicyController(
                ...
                systemHardBypassPackages =
                    systemHardBypass.packages,
                systemHardBypassUids =
                    systemHardBypass.uids
            )
